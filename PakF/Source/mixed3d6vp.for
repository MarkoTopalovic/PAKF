...
C=========================================================================
      SUBROUTINE Mixed3D6VP(GNODE,ALEVO,DESNO,SILE,NEL,
...
C      WDT=W(IBRGT,I)*W(IBRGT,J)*DETJ
      ...
      WT=WGT(JR)*WGT(JS)*WGT(JT)
       ...
       CALL JACTNP6(R,S,T,DET1,CK,0,PJ,HV1,HV2,HV3,H,HP,TT21
...
C       KFIX=1
       CALL JACTNP6(R,S,T,DET1,CK,KFIX,PJ,HV1,HV2,HV3,H,HP,TT21
     1,DET,SF1,SF2,SF3,NBREL,HXU,HYU,HZU,HXV,HYV,HZV,HXW,HYW,HZW,
     &AMI,NDIM,ISRPS,IIZLAZ,IUPWIN,NEL,SHEAR,ZVXT,ZVYT,ZVZT,DTEMPDN,
     &NDIMP)
C
...
c	endif
399   CALL SSTRES6(NEL,NDIM,ID,CK,PJ,H,HP,TT21,AMI,ISRPS,NUMZAD,
...
C=======================================================================
C==========================================================================
      SUBROUTINE NODEADD6(CORD,NPT,ID,NEL,NDIM,NET,IIZLAZ)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      DIMENSION CORD(3,*)
      DIMENSION ID(6,*)
...
C==========================================================================
C==========================================================================
       SUBROUTINE JACTNP6(R,S,T,DET1,CK,KFIX,PJ,HV1,HV2,HV3,H,HP,TT21
     1,DET,SF1,SF2,SF3,NBREL,HXU,HYU,HZU,HXV,HYV,HZV,HXW,HYW,HZW,
     &AMI,NDIM,ISRPS,IIZLAZ,IUPWIN,NEL,SHEAR,ZVXT,ZVYT,ZVZT,DTEMPDN,
     &NDIMP)
       IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C==========================================================================
C==========================================================================
      SUBROUTINE SSTRES6(NEL,NDIM,ID,CK,PJ,H,HP,TT21,AMI,ISRPS,NUMZAD,
     &IIZLAZ,IUPWIN,XG,WGT,NREF,IBRGT,PRES,INDEL,NBREL,NZAD,ZADVRE)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C      GOTO 300
 ...
 150   CALL JACTNP6(R,S,T,DET1,CK,KFIX,PJ,HV1,HV2,HV3,H,HP,TT21
     1,DET,SF1,SF2,SF3,NBREL,HXU,HYU,HZU,HXV,HYV,HZV,HXW,HYW,HZW,
     &AMI,NDIM,ISRPS,IIZLAZ,IUPWIN,NEL,SHEAR,ZVXT,ZVYT,ZVZT,DTEMPDN,
     &ndimp)
...
C==========================================================================
C==========================================================================
      SUBROUTINE FILLN2P6(GNODE,SILE,ID,NPT,IPASS)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
