C=========================================================================
      SUBROUTINE Mixed3d8nodePoisson(GNODE,ALEVO,DESNO,SILE,NEL,
     ...
     &VMESH,IALE,AF,NJUTRA,ISYMMS,ITER,IPASS)
...
c      IF (KLM.LE.NDIMP) LM2(KLM+3*NDIM)=ID(4,NEL(KLM,NBREL))
      IF (KLM.LE.NDIMP) LM2(KLM+3*NDIM)=ID(4,NEL(ndim+1,NBREL))
...
C=========================================================================
	...
	GNODE(1,MESTO,NODE)=ZADVRE(NZDT)*FK1
...
C      AKMIV3(K,N)=AKMIV1(K,N)
	...
	AKPP=AKPP+WDT*(PJ(1,K)*PJ(1,N)+PJ(2,K)*PJ(2,N)+PJ(3,K)*PJ(3,N))
...
C==========================================================================
	IF (IPASS.EQ.0) THEN
       SKEF(I+3*NDIM,I+3*NDIM)=SKEF(I+3*NDIM,I+3*NDIM)+AKPP
C     &AKV1P(J,I)*AKV1P(J,I)+AKV2P(J,I)*AKV2P(J,I)+AKV3P(J,I)*AKV3P(J,I)
	ENDIF
C==========================================================================
      ENDIF
...
C==========================================================================
	IF (IPASS.EQ.0) THEN
      ...
      DO 311 I=1,NDIMP
      DO 301 J=1,NDIM
       F92(I+3*NDIM)=F92(I+3*NDIM)-AKV1P(J,I)*F92(J)/WDT
       F92(I+3*NDIM)=F92(I+3*NDIM)-AKV2P(J,I)*F92(J+NDIM)/WDT
       F92(I+3*NDIM)=F92(I+3*NDIM)-AKV3P(J,I)*F92(J+2*NDIM)/WDT
       F92(I+3*NDIM)=F92(I+3*NDIM)-AKPP*TT21(I+3*NDIM)
C     &(AKV1P(J,I)*AKV1P(J,I)+AKV2P(J,I)*AKV2P(J,I)+
C     &AKV3P(J,I)*AKV3P(J,I))*TT21(I+3*NDIM)
C==========================================================================
 301  CONTINUE
 311  CONTINUE
      ENDIF
